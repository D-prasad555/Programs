...
public class _4FindNewsIdWhichHasReceivedMaxComments
{
	public static void main(String[] args)
	{
		...
		System.out.println(size.get().newsId);
		
		/*long count=newsData.stream().flatMap(s->s.getComment()).filter(s->s.contains("budget")).count();
